...
const ContentCalender = () => {
    return (
        <div style={{display: 'flex', width: '100%', height: "67%", flexWrap: "wrap",}}>
            <div className="days_on"/>
            <div className="days_on"/>
            <div className="days_on"/>
            <div className="days_on"/>
            <div className="days_on"><h2 style={{marginTop: "20px"}}>1</h2></div>
            <div className="days_on"><h2 style={{marginTop: "20px"}}>2</h2></div>
            <div className="days_on" style={{borderRight: "none"}}><h2 style={{marginTop: "20px"}}>3</h2></div>
            ...
            <div className="days_on"><h2 style={{marginTop: "20px"}}>15</h2></div>
            ...
            <div className="days_on"><h2 style={{marginTop: "20px"}}>18</h2></div>
            <div className="days_on"><h2 style={{marginTop: "20px"}}>19</h2></div>
